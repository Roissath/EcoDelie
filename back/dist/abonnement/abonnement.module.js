...
const abonnement_entity_1 = require("./abonnement.entity");
...
exports.AbonnementModule = AbonnementModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([abonnement_entity_1.Abonnement, utilisateur_entity_1.Utilisateur])],
