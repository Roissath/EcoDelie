...
let StatsService = class StatsService {
    ...
    async getDashboardStats(filters) {
        ...
        if (utilisateurId) {
            ...
            console.log(`📦 Commandes client: ${commandes.length}, 🚚 Livraisons client: ${livraisons.length}, 📢 Annonces client: ${annonces.length}, 💰 Dépense totale: ${totalDepense}`);
            return {
...
exports.StatsService = StatsService = __decorate([
    ...
    __metadata("design:paramtypes", [Function, Function, Function, Function, Function, Function, Function, Function, Function, Function])
], StatsService);
