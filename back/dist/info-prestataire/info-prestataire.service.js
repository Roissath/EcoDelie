...
exports.InfoPrestataireService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const info_prestataire_entity_1 = require("./info-prestataire.entity");
let InfoPrestataireService = class InfoPrestataireService {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.InfoPrestataireService = InfoPrestataireService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(info_prestataire_entity_1.InfoPrestataire)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], InfoPrestataireService);
//# sourceMappingURL=info-prestataire.service.js.map